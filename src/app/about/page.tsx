...
export default function AboutPage() {
  return (
    <div className="max-w-5xl mx-auto px-6 py-12 bg-white text-gray-800"> {/* Force light background and text */}
      {/* Heading */}
      <motion.h1
      ...
      <motion.p
        ...
        className="text-lg text-gray-800 text-center mb-12 max-w-3xl mx-auto"
      >
      ...
      <div className="grid md:grid-cols-2 gap-10">
        ...
        <motion.section
          ...
          className="bg-white rounded-xl p-6 shadow-md border border-gray-200" // removed dark mode classes
        >
          <h2 className="flex items-center text-2xl font-semibold text-gray-800 gap-2 mb-3">
        ...
        <motion.section
          ...
          className="md:col-span-2 bg-white rounded-xl p-6 shadow-md border border-gray-200"
        >
          <h2 className="flex items-center text-2xl font-semibold text-gray-800 gap-2 mb-3">
      ...
      >
        ...
        <p className="text-gray-800 text-center mb-6 max-w-2xl mx-auto">
