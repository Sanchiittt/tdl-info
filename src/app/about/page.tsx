...
//       <h1 className="text-3xl font-bold text-blue-700 mb-4">About TDL (Tally Definition Language)</h1>

//       <p className="mb-4 text-gray-700">
//         <strong>TDL</strong> stands for <strong>Tally Definition Language</strong>. It is the programming language used to customize and extend the capabilities of <strong>Tally ERP 9</strong> or <strong>TallyPrime</strong>, which are widely used accounting and business management software in India and globally.
//       </p>

//       <h2 className="text-xl font-semibold text-gray-800 mb-2">What is TDL?</h2>
//       <p className="mb-4 text-gray-700">
//         TDL allows developers and accountants to customize Tally’s user interface, reports, data fields, and automate tasks. It is designed to be human-readable and easy to use by people with basic programming knowledge.
//       </p>

//       <h2 className="text-xl font-semibold text-gray-800 mb-2">Why is TDL used?</h2>
//       <ul className="list-disc list-inside text-gray-700 mb-4">
//         <li>To add custom fields in vouchers, ledgers, and reports</li>
//         <li>To create tailor-made invoices and reports for specific business needs</li>
//         <li>To automate repetitive data entry tasks</li>
//         <li>To connect Tally with external systems like Excel, websites, or other software</li>
//       </ul>

//       <h2 className="text-xl font-semibold text-gray-800 mb-2">How does TDL work?</h2>
//       <p className="mb-2 text-gray-700">
//         TDL is loaded into Tally either as a `.tdl` file or via the Tally Developer tool. Once added, TDL code modifies or extends Tally’s default behavior — for example, it can:
//       </p>
//       <ul className="list-disc list-inside text-gray-700 mb-4">
//         <li>Show a new column in the sales report</li>
//         <li>Ask for extra input when entering a voucher</li>
//         <li>Auto-calculate taxes or discounts</li>
//       </ul>
//     </div>
//   );
// }
...
//         {/* What is TDL */}
//         <section>
//           <h2 className="text-2xl font-semibold text-gray-800 mb-2">What is TDL?</h2>
...
//         {/* Why use TDL */}
//         <section>
//           <h2 className="text-2xl font-semibold text-gray-800 mb-2">Why use TDL?</h2>
...
//           <h2 className="text-2xl font-semibold text-gray-800 mb-2 mt-4">How does TDL work?</h2>
...
//           <Image
//             src="/images/tdl-tally-integration.png" // ✅ Replace with your actual diagram image path
